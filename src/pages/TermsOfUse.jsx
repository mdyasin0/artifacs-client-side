  ...
  return (
    <div className="bg-[#faf4ec] min-h-screen px-6 py-10 text-[#3a3a3a]">
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-xl p-8 border border-[#ddd]">
        <h1 className="text-3xl font-bold mb-6 text-[#2f2e2e]">Terms of Use</h1>

        <section className="mb-6">
          <h2 className="text-xl font-semibold mb-2">1. Acceptance of Terms</h2>
          <p>
            By accessing and using the Historical Artifacts Tracker, you agree
        ...
        <section className="mb-6">
          ...
          <p>
            Users may contribute artifacts and information. You are responsible
            for ensuring the accuracy and authenticity of your submissions. We
            reserve the right to remove any content deemed inappropriate or
            misleading.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            All content including images, text, and design elements are either
            owned by us or used with permission. You may not copy, reproduce, or
        ...
        <section className="mb-6">
          ...
          <p>
            Users may like and engage with artifact listings. These interactions
            are tracked and visible to enhance community experience. Abuse of
            this system may result in account restrictions.
          </p>
        </section>
        ...
        <section className="mb-6">
          ...
          <p>
            ...
            without notice. Continued use after modifications indicates your
